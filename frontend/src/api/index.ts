...
export const api = {
  ...
  admin: {
    ...
    deleteVersion: (id: number) => adminRequest.delete(`/admin/versions/${id}`),
    ...
    deleteGrade: (id: number) => adminRequest.delete(`/admin/grades/${id}`),
    ...
    deleteSubject: (id: number) => adminRequest.delete(`/admin/subjects/${id}`),
    ...
    deleteSemester: (id: number) => adminRequest.delete(`/admin/semesters/${id}`),
    ...
    deleteUnit: (id: number) => adminRequest.delete(`/admin/units/${id}`),
